...
const SalesView = () => {
  ...
  const topProducts = Object.values(productSalesMap).sort((a, b) => b.unitsSold - a.unitsSold).slice(0, 8);
  ...
  return (
    <div className={styles.page}>
      ...
      {loading ? (
        <div className={styles.spinner}><div className={styles.spinnerEl} /></div>
      ) : (
        <>
