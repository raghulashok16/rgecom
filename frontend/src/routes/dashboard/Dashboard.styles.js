export const styles = {
  ...
  // Sidebar bottom
  seedSection:     'px-4 py-4 border-t border-white/10',
  seedBtn:         'w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/15 disabled:opacity-40 disabled:cursor-not-allowed text-white text-xs font-medium px-4 py-2.5 rounded-xl transition-colors',
  seedCount:       'text-xs text-white/40 text-center mt-1.5',
